  ...
  return (
    <div style={{maxWidth:860,margin:'0 auto',padding:'2.5rem 2rem'}}>
      ...
      <div style={{ marginBottom:'1rem' }}>
        <BackButton to={'/buyer'} label="Retour" />
      </div>      <h1 style={{fontFamily:"'Cormorant Garamond', serif",fontSize:'2rem',color:C.forest,marginBottom:'1.5rem'}}>Mes devis envoyés</h1>
      {(data?.quotes||[]).map(q => (
